...
<head>
	...
	<link href="/91market./Application/Admin/Public/style/left.css" rel="stylesheet" type="text/css" />
    <script src="/91market./Application/Admin/Public/scripts/jquery-1.4.1.min.js" type="text/javascript"></script>
        ...
        <?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="navigation-list">
                <div class="navigation-item">
                    ...
                    <?php if(is_array($vo[child])): $i = 0; $__LIST__ = $vo[child];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><ul>
                            <li><a href="/91market/<?php echo (MODULE_NAME); ?>/<?php echo ($vo["title"]); ?>/<?php echo ($sub["title"]); ?>" target="main_right"> <!-- <img alt="" src="./Application/Admin/Public/images/tree/<?php echo ($vo["ico"]); ?>.png" style="float: left; margin: 10px 20px 0px 30px;" /> --><?php echo ($sub["name"]); ?></a></li>
